...
import type { MyJob, MyJobApiResponse } from '@/modules/my-jobs/types'
import { toMyJob } from '@/modules/my-jobs/utils/mappers'
import type { MyJobOffer, MyJobOfferApiResponse } from '@/modules/my-job-offers/types'
import { toMyJobOffer } from '@/modules/my-job-offers/utils/mappers'
