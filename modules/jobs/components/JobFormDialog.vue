...
interface Props {
  modelValue: boolean
  job?: Job | null
  graduateOptions: KeyValueOption[]
  submitting: boolean
...
const emit = defineEmits<{
  ...
  (e: 'submit', values: JobFormValues): void
  (e: 'closed'): void
}>()
...
watch(() => props.serverErrors, errors => {
  ...
  Object.entries(errors).forEach(([field, message]) => {
    formRef.value?.setFieldError(field as keyof JobFormValues, message)
  })
})
  ...
  >
    <VCard>
      ...
      <VCardText>
        <Form
          ref="formRef"
          :validation-schema="jobFormSchema"
