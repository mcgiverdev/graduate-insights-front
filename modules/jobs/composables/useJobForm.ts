...
const formFields = ['compania', 'cargo', 'modalidad', 'fechaInicio', 'fechaFin', 'graduateId', 'estado']
...
export const useJobForm = () => {
  ...
  const saveJob = async (payload: JobPayload, jobId?: number): Promise<RequestResult> => {
