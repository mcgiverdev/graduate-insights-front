export const PERU_GEO: Record<string, Record<string, string[]>> = {
  Amazonas: {
    ...
    Luya: [
      ...
      'Longuita', 'Lonya Chico', 'Luya', 'Luya Viejo', 'María', 'Ocalli', 'Ocumal',
      'Pisuquia', 'Providencia', 'San Cristóbal', 'San Francisco del Yeso',
  ...
  Áncash: {
    Huaraz: [
      ...
      'La Libertad', 'Olleros', 'Pampas Grande', 'Paucará', 'Piro', 'Tarica',
    ],
    ...
    Bolognesi: [
      'Chiquián', 'Abelardo Pardo Lezameta', 'Antonio Raimondi', 'Aquia', 'Cajacay',
      'Canis', 'Colquioc', 'Huallanca', 'Huasta', 'Huayllacayán', 'La Primavera',
      'Mangas', 'Pacllon', 'San Miguel de Corpanqui', 'Ticllos',
    ],
    Carhuaz: [
      'Carhuaz', 'Acopampa', 'Amashca', 'Anta', 'Ataquero', 'Marcará',
      'Pampayasta', 'Paria', 'San Miguel de Aco', 'Shilla', 'Tinco', 'Yungar',
    ],
    ...
    Huari: [
      'Huari', 'Anra', 'Cajay', 'Chavín de Huántar', 'Huacachi', 'Huacchis', 'Huachis',
      'Huantar', 'Masín', 'Paucas', 'Ponto', 'Rahuapampa', 'Rapayán', 'San Marcos',
    ...
    Pallasca: [
      'Cabana', 'Bolognesi', 'Conchucos', 'Huacaschuque', 'Huandoval', 'Lacabamba',
      'Llapo', 'Pallasca', 'Pampas', 'Santa Rosa', 'Tauca',
    ],
    Pomabamba: ['Pomabamba', 'Huayllan', 'Parobamba', 'Quinuabamba'],
    Recuay: [
      'Recuay', 'Catac', 'Cotaparaco', 'Huayllapampa', 'Llacllin', 'Marquillo',
      'Pampas Chico', 'Punta Callán', 'Tapacocha', 'Ticapampa',
    ],
    Santa: [
      'Chimbote', 'Cáceres del Perú', 'Coishco', 'Macate', 'Moro',
      'Nepeña', 'Samanco', 'Santa', 'Vinzos',
    ],
    Sihuas: [
      'Sihuas', 'Acobamba', 'Alfonso Ugarte', 'Cashapampa', 'Chingalpo',
      'Huayllabamba', 'Pacha', 'Palo Seco', 'Ragash', 'San Juan', 'Sicsibamba',
    ],
    Yungay: [
  ...
  Apurímac: {
    ...
    Andahuaylas: [
      ...
      'Kishuara', 'Pacobamba', 'Pacucha', 'Pampachiri', 'Pomacocha',
      'San Antonio de Cachi', 'San Jerónimo', 'San Miguel de Chaccrampa',
      'Santa María de Chicmo', 'Talavera', 'Tumay Huaraca', 'Turpo',
      'Kaquiabamba', 'José María Arguedas',
    ],
    Antabamba: [
    ...
    Aymaraes: [
      'Chalhuanca', 'Capaya', 'Caraybamba', 'Chapimarca', 'Colcabamba', 'Cotaruse',
      'Huayllo', 'Justo Apu Sahuaraura', 'Lucre', 'Pocohuanca', 'San Juan de Chacña',
  ...
  Arequipa: {
    Arequipa: [
      ...
      'Socabaya', 'Tiabaya', 'Uchumayo', 'Vítor', 'Yanahuara',
      'Yarabamba', 'Yura', 'José María Quimper',
    ],
    Camaná: [
    ...
    Caravelí: [
      ...
      'Chala', 'Chaparra', 'Huanuhuanu', 'Jaqui', 'Lomas', 'Quicacha', 'Yauca',
    ],
    Castilla: [
      'Aplao', 'Andagua', 'Ayo', 'Chachas', 'Chilcaymarca', 'Choco',
      'Huancarqui', 'Machaguay', 'Orcopampa', 'Pampacolca', 'Puyca',
      'Tipan', 'Uñon', 'Uraca', 'Viraco',
    ],
    Caylloma: [
      'Chivay', 'Achoma', 'Cabanaconde', 'Callalli', 'Caylloma', 'Coporaque',
      'Huambo', 'Huanca', 'Ichupampa', 'Lari', 'Lluta', 'Maca', 'Madrigal',
      'San Antonio de Chuca', 'Sibayo', 'Tapay', 'Tisco', 'Tuti', 'Yanque', 'Majes',
    ],
    Condesuyos: [
  ...
  Ayacucho: {
    Huamanga: [
      ...
      'Jesús Nazareno', 'Andrés Avelino Cáceres Dorregaray',
    ],
    ...
    Huanta: [
      'Huanta', 'Ayahuanco', 'Huamanguilla', 'Iguaín', 'Luricocha',
      'Llochegua', 'Canayre', 'Uchuraccay', 'Pucacolpa', 'Santillana',
    ],
    'La Mar': [
    ...
    Lucanas: [
      'Puquio', 'Aucara', 'Cabana', 'Carmen Salcedo', 'Chaviña', 'Chipao',
      'Huac-Huas', 'Laramate', 'Leoncio Prado', 'Llauta', 'Lucanas', 'Ocaña',
      'Otoca', 'Saisa', 'San Cristóbal', 'San Juan', 'San Pedro',
      'San Pedro de Palco', 'Sancos', 'Santa Ana de Huaycahuacha', 'Santa Lucía',
    ],
    Parinacochas: [
    ...
    'Páucar del Sara Sara': [
      'Pausa', 'Colta', 'Corculla', 'Lampa', 'Marcabamba', 'Oyolo',
      'Pararca', 'San Javier de Alpabamba', 'San José de Ushua', 'Sara Sara',
    ],
    Sucre: [
      'Querobamba', 'Belén', 'Chalcos', 'Chilcayoc', 'Huacaña',
      'Morcolla', 'Paico', 'San Salvador de Quije', 'Santiago de Paucaray', 'Soras',
    ],
    'Víctor Fajardo': [
      'Huancapi', 'Alcamenca', 'Apongo', 'Asquipata', 'Canaria',
      'Cayara', 'Colca', 'Huaya', 'Sarhua', 'Vilcanchos',
    ],
    'Vilcas Huamán': [
  ...
  Cajamarca: {
    Cajamarca: [
      ...
      'Llacanora', 'Los Baños del Inca', 'Magdalena', 'Namora', 'San Juan',
    ],
    ...
    Chota: [
      'Chota', 'Anguia', 'Chadin', 'Chalamarca', 'Chiguirip', 'Chimban', 'Choropampa',
      'Cochabamba', 'Conchan', 'Huambos', 'Lajas', 'Llama', 'Miracosta', 'Paccha',
    ...
    'San Marcos': [
      ...
      'Ichocan', 'José Manuel Quiroz', 'José Sabogal',
    ],
    'San Miguel': [
  ...
  Cusco: {
    ...
    Espinar: [
      ...
      'Pallpata', 'Pichigua', 'Suyckutambo', 'Alto Pichigua',
    ],
    'La Convención': [
      'Santa Ana', 'Echarate', 'Huayopata', 'Maranura', 'Ocobamba', 'Quellouno',
      'Kimbiri', 'Santa Teresa', 'Vilcabamba', 'Pichari', 'Inkawasi',
  ...
  Huancavelica: {
    Huancavelica: [
      ...
      'Nuevo Occoro', 'Palca', 'Pilchaca', 'Vilca', 'Yauli', 'Ascensión', 'Huando',
    ],
    Acobamba: ['Acobamba', 'Andabamba', 'Anta', 'Caja', 'Marcas', 'Paucara', 'Pomacocha', 'Rosario'],
    Angaraes: [
      'Lircay', 'Anchonga', 'Callanmarca', 'Ccochaccasa', 'Chincho', 'Congalla',
      'Huanca-Huanca', 'Huayllay Grande', 'Julcamarca', 'San Antonio de Antaparco',
      'Santo Tomás de Pata', 'Secclla',
    ],
    Castrovirreyna: [
      'Castrovirreyna', 'Arma', 'Aurahua', 'Capillas', 'Chupamarca', 'Cocas',
      'Huachos', 'Huamatambo', 'Mollepampa', 'San Juan', 'Santa Ana', 'Tantará', 'Ticrapo',
    ],
    Churcampa: [
    ...
    Huaytará: [
      'Huaytará', 'Ayavi', 'Córdova', 'Huayacundo Arma', 'Laramarca', 'Ocoyo',
    ...
    Tayacaja: [
      ...
      'Daniel Hernández', 'Huachocolpa', 'Huaribamba', 'Ñahuimpuquio', 'Pazos',
  ...
  Huánuco: {
    Huánuco: [
      ...
      'San Francisco de Cayran', 'San Pedro de Chaulan', 'Santa María del Valle',
    ...
    'Leoncio Prado': [
      'Tingo María', 'Daniel Alomía Robles', 'Hermílio Valdizán',
    ...
    Lauricocha: [
      'Jesús', 'Baños', 'Jivia', 'Queropalca', 'Rondos',
  ...
  Ica: {
    ...
    Chincha: [
      'Chincha Alta', 'Alto Larán', 'Chavin', 'El Carmen', 'Grocio Prado',
      'Chincha Baja', 'Pueblo Nuevo', 'San Juan de Yanac',
  ...
  Junín: {
    Huancayo: [
      ...
      'Pucará', 'Quichuay', 'Quilcas', 'San Agustín', 'San Jerónimo de Tunan',
      'Saño', 'Sapallanga', 'Sicaya', 'Santo Domingo de Acobamba', 'Viques',
    ],
    Chanchamayo: [
      'La Merced', 'Perené', 'Pichanaqui',
      'San Luis de Shuaro', 'San Ramón', 'Vitoc',
    ],
    Chupaca: [
      'Chupaca', 'Ahuac', 'Chongos Bajo', 'Huachac', 'Huamancaca Chico',
      'San Juan de Iscos', 'San Juan de Jarpa', 'Tres de Diciembre', 'Yanacancha',
    ],
    Concepción: [
      'Concepción', 'Aco', 'Andamarca', 'Chambara', 'Cochas', 'Comas',
      'Heroínas Toledo', 'Manzanares', 'Mariscal Castilla', 'Matahuasi', 'Mito',
      'Nueve de Julio', 'Orcotuna', 'San José de Quero', 'Santa Rosa de Ocopa',
    ],
    Jauja: [
      'Jauja', 'Acolla', 'Apata', 'Ataura', 'Canchayllo', 'Curicaca', 'El Mantaro',
      'Huamali', 'Huaripampa', 'Huertas', 'Janjaillo', 'Julcán', 'Leonor Ordóñez',
      'Llocllapampa', 'Marco', 'Masma', 'Masma Chicche', 'Molinos', 'Monobamba',
      'Muqui', 'Muquiyauyo', 'Paca', 'Paccha', 'Pancan', 'Parco', 'Pomacancha',
      'Ricran', 'San Lorenzo', 'San Pedro de Chunan', 'Sausa', 'Sincos',
      'Tunan Marca', 'Yauli', 'Yauyos',
    ],
    Junín: ['Junín', 'Carhuamayo', 'Ondores', 'Ulcumayo'],
    Satipo: [
      'Satipo', 'Coviriali', 'Llaylla', 'Mazamari', 'Pampa Hermosa',
      'Pangoa', 'Río Negro', 'Río Tambo', 'Vizcatán del Ene',
    ],
    Tarma: [
      'Tarma', 'Acobamba', 'Huaricolca', 'Huasahuasi', 'La Unión',
      'Palca', 'Palcamayo', 'San Pedro de Cajas', 'Tapo',
    ],
    Yauli: [
      'La Oroya', 'Chacapalpa', 'Huay-Huay', 'Marcapomacocha', 'Morococha',
      'Paccha', 'Santa Bárbara de Carhuacayan', 'Santa Rosa de Sacco',
      'Suitucancha', 'Yauli',
    ],
  },
  ...
  'La Libertad': {
    ...
    Ascope: [
      'Ascope', 'Chicama', 'Chocope', 'Guadalupito',
      'Macabi Alto', 'Paiján', 'Rázuri', 'Santiago de Cao',
    ],
    ...
    Otuzco: [
      'Otuzco', 'Agallpampa', 'Charat', 'Huaranchal', 'La Cuesta',
      'Mache', 'Paranday', 'Salpo', 'Sinsicap', 'Usquil',
    ],
    Pacasmayo: ['San Pedro de Lloc', 'Guadalupe', 'Jequetepeque', 'Pacasmayo', 'San José'],
    Pataz: [
      'Tayabamba', 'Buldibuyo', 'Chillia', 'Huaylillas', 'Huancaspata',
      'Huayo', 'Ongon', 'Parcoy', 'Pataz', 'Pias',
      'Santiago de Challas', 'Taurija', 'Urpay',
    ],
    'Sánchez Carrión': [
      'Huamachuco', 'Chugay', 'Cochorco', 'Curgos',
      'Marcabal', 'Sarín', 'Sartimbamba', 'Sanagorán',
    ],
    'Santiago de Chuco': [
      'Santiago de Chuco', 'Angasmarca', 'Cachicadan', 'Mollebamba', 'Mollepata',
      'Quiruvilca', 'Santa Cruz de Chuca', 'Sitabamba', 'Ucrumarca',
    ],
  ...
  Lambayeque: {
    Chiclayo: [
      ...
      'Pimentel', 'Pomalca', 'Pucalá', 'Reque', 'Santa Rosa', 'Saña',
      'Cayaltí', 'Pátapo', 'Tumán',
    ],
    Ferreñafe: [
      'Ferreñafe', 'Cañaris', 'Incahuasi',
      'Manuel Antonio Mesones Muro', 'Pitipo', 'Pueblo Nuevo',
    ],
    Lambayeque: [
      'Lambayeque', 'Chóchope', 'Illimo', 'Jayanca', 'Mochumí',
  ...
  Lima: {
    Lima: [
      ...
      'Pueblo Libre', 'Punta Hermosa', 'Punta Negra', 'Rímac', 'San Bartolo',
    ...
    Cañete: [
      ...
      'Pacarán', 'Quilmaná', 'San Antonio', 'San Luis',
    ...
    Huarochirí: [
      ...
      'San Pedro de Huancayre', 'Santa Eulalia', 'Santiago de Anchucaya',
      'Santiago de Tuna', 'Santo Domingo de Los Olleros', 'Surco',
    ],
    Huaura: [
      'Huacho', 'Ambar', 'Caleta de Carquín', 'Checras', 'Hualmay', 'Huaura',
      'Leoncio Prado', 'Paccho', 'Santa Leonor', 'Santa María', 'Sayán', 'Vegueta',
    ],
    Oyón: ['Oyón', 'Andajes', 'Caujul', 'Cochamarca', 'Naván', 'Pachangara'],
    Yauyos: [
      'Yauyos', 'Alis', 'Allauca', 'Ayavirí', 'Azángaro', 'Cacra', 'Carania',
      'Catahuasi', 'Chocos', 'Comas', 'Hongos', 'Huampara', 'Huancaya',
      'Huangáscar', 'Huantán', 'Huañec', 'Laraos', 'Lincha', 'Madeán',
  ...
  Loreto: {
    Maynas: [
      ...
      'Mazan', 'Napo', 'Punchana', 'Putumayo', 'Torres Causana', 'Belén',
    ],
    'Alto Amazonas': [
      'Yurimaguas', 'Balsapuerto', 'Barranca', 'Cahuapanas',
      'Jeberos', 'Lagunas', 'Santa Cruz', 'Teniente César López Rojas',
    ],
  ...
  Pasco: {
    Pasco: [
      ...
      'Paucartambo', 'San Francisco de Asís de Yarusyacan', 'Simón Bolívar',
  ...
  Piura: {
    ...
    Huancabamba: [
      ...
      'Lalaquiz', 'San Miguel del Faique', 'Sondor', 'Sondorillo',
    ],
    Morropón: [
  ...
  Puno: {
    ...
    Azángaro: [
      ...
      'José Domingo Choquehuanca', 'Muñani', 'Potoni', 'Saman', 'San Antón',
    ...
    Huancané: [
      'Huancané', 'Cojata', 'Huatasani', 'Inchupalla',
      'Pusi', 'Rosaspata', 'Taraco', 'Vilque Chico',
    ],
    Lampa: [
    ...
    Melgar: [
      'Ayaviri', 'Antauta', 'Cupi', 'Llalli', 'Macarí',
  ...
  'San Martín': {
    ...
    'San Martín': [
      ...
      'Morales', 'Papaplaya', 'San Antonio', 'Sauce',
    ],
  ...
  Ucayali: {
    'Coronel Portillo': [
      'Callería', 'Campoverde', 'Iparía', 'Masisea',
