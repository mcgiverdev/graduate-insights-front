...
import { useDirectorRepository } from '@/library/directorRepository'
...
watch([page, itemsPerPage], () => {
  fetchDirectors({ page: page.value, size: itemsPerPage.value })
}, { immediate: true })
  ...
  <section>
    <VCard class="mb-6">
      ...
      <AddDirectorDialog
        ...
        @success="() => { fetchDirectors({ page: page.value, size: itemsPerPage.value }); isAddDirectorDialogVisible = false }"
